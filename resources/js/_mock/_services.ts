...
<h6>Objectifs</h6>
<ul>
  <li>Comprendre les bases de l'intelligence artificielle générative</li>
  <li>Identifier les opportunités d'application dans votre secteur</li>
  <li>Sensibiliser aux enjeux éthiques et réglementaires</li>
  <li>Inspirer l'innovation au sein de votre organisation</li>
</ul>
<h6>Public cible</h6>
...
<ol>
  <li><strong>Analyse de maturité</strong> : Évaluation de votre niveau actuel en IA</li>
  <li><strong>Identification des opportunités</strong> : Détection des cas d'usage prioritaires</li>
  <li><strong>Recommandations stratégiques</strong> : Plan d'action personnalisé</li>
  <li><strong>Accompagnement</strong> : Suivi dans la mise en œuvre</li>
</ol>
<h6>Livrables</h6>
<ul>
...
<ul>
  <li><strong>Sessions individuelles</strong> : Coaching personnalisé selon vos besoins</li>
  <li><strong>Formation pratique</strong> : Mise en œuvre sur vos propres projets</li>
  <li><strong>Suivi régulier</strong> : Points d'avancement et ajustements</li>
  <li><strong>Support continu</strong> : Disponible pour vos questions</li>
</ul>
<h6>Avantages</h6>
<ul>
  <li>Contenu 100% sur mesure</li>
  <li>Rythme adapté à votre disponibilité</li>
